...
HI_S32 HI_MPI_VPSS_GetGrpRegionLumaEx(VPSS_GRP VpssGrp,VPSS_REGION_INFO_S *pstRegionInfo,
                                                VPSS_LUMA_INFO_S *pstLumaData,HI_S32 s32MilliSec);
HI_S32 HI_MPI_VPSS_EnableOneBuf(VPSS_GRP VpssGrp, VPSS_CHN VpssChn);
HI_S32 HI_MPI_VPSS_DisableOneBuf(VPSS_GRP VpssGrp, VPSS_CHN VpssChn);
#ifdef __cplusplus
#if __cplusplus
}
#endif
