...
HI_S32 HI_MPI_HDMI_SetHwSpec(HI_HDMI_ID_E enHdmi, const HI_HDMI_HW_SPEC_S *pstHwSpec);
HI_S32 HI_MPI_HDMI_GetHwSpec(HI_HDMI_ID_E enHdmi, HI_HDMI_HW_SPEC_S *pstHwSpec);
