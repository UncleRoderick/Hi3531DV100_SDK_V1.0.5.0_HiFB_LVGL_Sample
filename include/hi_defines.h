...
#define HI3521D_V100 0x3521d100
#define HI3520D_V300 0x3520d300
#define HI3531A_V100 0x3531a100
#define HI3531D_V100 0x3531d100
...
#define HI3536D_V100 0x3536d100
    ...
    #define MPP_VER_PRIX "_MPP_V"
#elif HICHIP==HI3521D_V100
    #define CHIP_NAME    "Hi3521D"
    #define MPP_VER_PRIX "_MPP_V"
#elif HICHIP==HI3531A_V100
    #define CHIP_NAME    "Hi3531A"
    #define MPP_VER_PRIX "_MPP_V"
#elif HICHIP==HI3531D_V100
    #define CHIP_NAME    "Hi3531D"
    #define MPP_VER_PRIX "_MPP_V"
...
#define VPSS_NR_REF_BLK_SIZE(Width, Height, PixFormat, size)\
	do{\
        HI_U32 u32AlignWidth, u32AlignHeight, u32AlignMadWidth, u32AlignMadHeight;\
        HI_U32 u32YSize, u32CSize, u32TotalSize;\
        HI_U32 u32MadBufSizeW,u32MadBufSizeH, u32MaxMadSize;\
        u32AlignWidth    = ((Width  +  15)>>4)<<4;\
        u32AlignHeight   = ((Height +  15)>>4)<<4;\
        u32YSize = u32AlignWidth * u32AlignHeight;\
        u32CSize = (PixFormat == PIXEL_FORMAT_YUV_SEMIPLANAR_420) ? (u32YSize >> 1) : u32YSize;\
        u32TotalSize     = u32YSize + u32CSize;\
        u32MadBufSizeW = ((((u32AlignWidth>>3)  +  15)>>4)<<4)*u32AlignHeight;\
        u32MadBufSizeH = ((((u32AlignHeight>>3)  +  15)>>4)<<4)*u32AlignWidth;\
        u32MaxMadSize = u32MadBufSizeW > u32MadBufSizeH ? u32MadBufSizeW : u32MadBufSizeH;\
        size = u32TotalSize + u32MaxMadSize;\
    }while(0)
#ifdef __cplusplus
#if __cplusplus
}
