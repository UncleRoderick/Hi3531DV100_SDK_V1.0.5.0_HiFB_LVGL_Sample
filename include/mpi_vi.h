...
HI_S32 HI_MPI_VI_SetChnEarlyInterrupt(VI_CHN ViChn, const VI_EARLY_INTERRUPT_S *pstEarlyInterrupt);
HI_S32 HI_MPI_VI_GetChnEarlyInterrupt(VI_CHN ViChn, VI_EARLY_INTERRUPT_S *pstEarlyInterrupt);
#ifdef __cplusplus
#if __cplusplus
}
#endif
